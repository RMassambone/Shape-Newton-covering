...
program algencama
  ...
  pdata%xpol(4, 1:pdata%nvpols(4)) = (/ put(1,46), put(1,83), put(1,64), put(1,102), put(1,81), put(1,82), put(1,43), put(1,46) /)
  pdata%ypol(4, 1:pdata%nvpols(4)) = (/ put(2,46), put(2,83), put(2,64), put(2,102), put(2,81), put(2,82), put(2,43), put(2,46) /)
  ...
  lbnd(n) = 0.0d0
  uind(n) = .true.
  ubnd(n) = 0.5d0 * sqrt( (dabs(pdata%dtr(1) - pdata%dbl(1)))**2.0d0 + (dabs(pdata%dtr(2) - pdata%dbl(2)))**2.0d0 )
...
contains
  ...
  subroutine drawsol(n,x)
    ...
    write(filename,"(A16,I0,A3)") 'covering-america',nballs,'.mp'
